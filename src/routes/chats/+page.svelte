...
<SideMenu bind:allBrands bind:brandsSelected bind:callDuration bind:chatFiles bind:currentPagination bind:freeGuests
          bind:sideMenuOpen bind:supportSelected />
