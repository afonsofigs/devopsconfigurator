  ...
  <div class="d-flex flex-column justify-content-start gap-4">
    ...
    <div>
      ...
      <div class="d-flex flex-row justify-content-start gap-2">
        <MultiSelect
          bind:selected={selfHostedOSsSelected}
          options={OSs}
          placeholder="Self-hosted OSs: All"
        />
        <Input
          bind:value={boolSelfHostedBuild}
          id="exampleSelect"
          name="select"
          style="width: 80px"
          type="select"
    ...
    <NumberInput
      bind:value={concurrentBuilds}
      label="Cloud concurrent builds:"
      max="1000"
      min="0"
      placeholder="builds"
    />
    ...
    <NumberInput
      bind:value={linuxMonthlyCloudMins}
      label="Linux monthly cloud minutes:"
      min="0"
      placeholder="linuxMinutes"
      width="90px"
    />

    <NumberInput
      bind:value={dockerMonthlyCloudMins}
      label="Docker monthly cloud minutes:"
      placeholder="dockerMinutes"
      width="90px"
    />

    <NumberInput
      bind:value={windowsMonthlyCloudMins}
      label="Windows monthly cloud minutes:"
      placeholder="windowsMinutes"
      width="90px"
    />

    <NumberInput
      bind:value={macOSMonthlyCloudMins}
      label="macOS monthly cloud minutes:"
      placeholder="macOSMinutes"
      width="90px"
    />
    ...
    <div>
      ...
      <MultiSelect
        bind:selected={supportSelected}
        options={supports}
        placeholder="Support: All"
      />
    </div>
