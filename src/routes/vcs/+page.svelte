...
<SideMenu bind:allBrands bind:brandsSelected bind:currentPagination bind:diskSpace bind:kanbanChecked
          bind:packageRegistryChecked bind:sideMenuOpen bind:supportSelected />
